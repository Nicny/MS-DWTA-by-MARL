...
def get_common_args():
    ...
    parser.add_argument('--simulate_compression', type=int, default=4, help='the speed of simulation')
    parser.add_argument('--scenario_name', type=str, default='air_defense.scen', help='the name of the scenario')
    parser.add_argument('--n_enemies', type=int, default=40, help='the number of targets')
    ...
    parser.add_argument('--ship_value', type=list, default=[0.6, 0.6, 0.6, 0.8, 0.8, 0.8, 1.0])
...
# arguments of algorithms
def get_algo_args(args):
    # network
    ...
    # DDN
    args.ddn_n_quantiles = 1

    # DPLEX
    args.dplex_embed_dim = 64
    args.unit_dim = 7
    args.attend_reg_coef = 0.001
    args.dplex_num_kernel = 4
    args.dplex_adv_hypernet_embed = 64

    # FOR all DFAC algo
    args.n_quantiles = 8
    args.n_approx_quantiles = 32
    args.quantile_embed_dim = 64
    args.phi_dim = 64
